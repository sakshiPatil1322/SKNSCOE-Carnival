  ...
  return (
    <Layout>
      <div className="p-6 flex flex-col items-center mt-5">
        <h2 className="text-2xl font-bold mb-4 mt-5">Event Management</h2>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-5 rounded-xl shadow-lg w-[90%] max-w-md">
            <h3 className="text-xl font-semibold mb-4 text-red-600">Are you sure you want to delete this event?</h3>
            <p className="mb-2 text-sm text-gray-600">Type <strong>"yes"</strong> to confirm.</p>
            <input
              type="text"
